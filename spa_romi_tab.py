...
def page_romi():
    ...
    c2.metric("Total Marketing Led Increment", fmt_money(tot["total_incr_rev"]))
    ...
    # ============================================================
    # 4. Top performing campaigns / activities
    # ============================================================
    st.divider()
